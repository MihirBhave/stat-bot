import { ApplicationCommandOptionType, channelLink, ChannelType, EmbedBuilder, GuildChannel, GuildMember} from "discord.js";
...
const getChannelType = (chx : GuildChannel) : string | undefined => {
        switch(chx.type) {
            case ChannelType.GuildCategory: return "Category Channel";
            ...
            case ChannelType.GuildNews: return "News Channel";
            case ChannelType.GuildPublicThread: return "Public Thread";
                        ...
                        .addFields(
                            {
                                ...
                                Members In Channel : \`${channel.members.size}/${interaction.guild?.memberCount}\`
                                `
                            }
                        )
